    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(btnAnalizar1, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(137, 137, 137))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txtEntrada, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(31, 31, 31)
            ...
            while (true) {
                ...
                switch (tokens) {
                    case ERROR:
                        ...
                        break;
                    case Identificador:case Reservadas:
                        resultado += lexer.lexeme + ": Es una palabra " + tokens + "\n";
                        break;
                    case Positivo: case Negativo:
                        resultado += lexer.lexeme + ": Es una valor numerico " + tokens + "\n";
                        break;
                    case And: case Or: case Not: case Comparador: case Distinto: case Menor:
                    case Menor_Igual: case Mayor: case Mayor_Igual:
                        resultado +=tokens + ": Es un operador lógico \n";
                        break;
                    case Agrupacion:
                        resultado +=lexer.lexeme + " Es una "+ tokens+ "\n";
                        break;
                    case Delimitador:
                        resultado +=lexer.lexeme +" Es un Delimitador" + "\n" ;
                        break;
                    default:
                        
                        resultado +=lexer.lexeme + " Es un token: " + tokens + " \n";
                        break;
                }
            }
        } catch (FileNotFoundException ex) {
